...
require_once( DISTINCTIVE_CORE_PATH . 'page_builder_blocks/distinctpress-pro/testimonials_feed.php' );
require_once( DISTINCTIVE_CORE_PATH . 'page_builder_blocks/distinctpress-pro/testimonials_carousel.php' );
...
require_once( DISTINCTIVE_CORE_PATH . 'page_builder_blocks/distinctpress-pro/hero_slider.php' );
require_once( DISTINCTIVE_CORE_PATH . 'page_builder_blocks/distinctpress-pro/media_grid.php' );
require_once( DISTINCTIVE_CORE_PATH . 'page_builder_blocks/distinctpress-pro/simple_button.php' );

require_once( DISTINCTIVE_CORE_PATH . 'page_builder_blocks/distinctpress-pro/revslider.php' );
